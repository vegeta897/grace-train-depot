...
<div class="rounded-b-box flex items-center justify-around bg-neutral px-4 py-2 pl-1">
	<div class="flex max-w-48 grow flex-col items-center gap-1">
		...
		<span class="leading-tight text-base-content/80"
			...
			{pluralize(cars.length, 'car')}</span
		>
	</div>
	<a href="/design/new?theme={encodeURIComponent(theme)}" class="btn btn-outline text-lg"
		>New</a
	>
</div>
