<section class="flex flex-col gap-4 p-4 lg:p-8">
	...
	<p>
		You may delete your account at any time, which will remove all of your user
		information and content. You may log in with Twitch again afterwards, but your train
		car designs will be gone.
	</p>
</section>
