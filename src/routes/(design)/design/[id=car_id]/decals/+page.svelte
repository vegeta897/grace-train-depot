...
<section class="flex w-full flex-col items-start gap-4 lg:flex-row">
	...
	<div
		class="rounded-box relative flex w-full flex-grow items-start gap-3 bg-neutral p-3 lg:w-1/2"
	>
		{#if $designCar.decals.length > 0}
			<ul
				class="flex w-[3.25rem] flex-col-reverse justify-end gap-0.5 rounded-lg bg-base-100 p-1"
			>
